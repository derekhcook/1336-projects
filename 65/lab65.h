...
class Time
{
 public:
  ...
  // (that is, hour, minute, and second are all zero), and 12:00:00
  // P.M. denotes noon (that is, hour equals 12 and minute and second
  // are both zero).
  bool isAM() const;
